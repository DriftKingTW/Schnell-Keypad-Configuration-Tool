import{y as n,d as a,r as s,_ as r,n as c,s as d,$ as e}from"./connect-3e6b1f54.517ee329.js";import"./index.0cc7491a.js";const l=n`
  <svg
    version="1.1"
    id="Capa_1"
...
`;let t=class extends d{render(){return e`
      <ewt-dialog
        open
    ...
    `}async _handleClose(){this.parentNode.removeChild(this)}};t.styles=[a,s`
      li + li,
      li > ul {
        margin-top: 8px;
      }
    ...
    `],t=r([c("ewt-no-port-picked-dialog")],t);const p=async i=>{const o=document.createElement("ewt-no-port-picked-dialog");return o.doTryAgain=i,document.body.append(o),!0};export{p as openNoPortPickedDialog};
